...
/// `SeatVaultV2ExploitsTest.test_X3_selfSeatLoop_drainsEpochCapPerEpoch` must take nothing.
///
///   GREEN (mitigated):  forge test --match-path test/audit-v2/SeatVaultV2X3Mitigation.t.sol
///   RED (launch params, not paused):  X3_UNMITIGATED=true forge test --match-path test/audit-v2/SeatVaultV2X3Mitigation.t.sol
contract SeatVaultV2X3MitigationTest is SeatVaultV2Base {
