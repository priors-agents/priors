...
allowed_top="AGENTS.md README.md LICENSE SECURITY.md BOUNTY.md package.json package-lock.json foundry.toml remappings.txt .env.example .gitignore .gitmodules .github bin deployments docs lib script scripts sdk skills src test"
